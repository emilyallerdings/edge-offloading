...
public class WekaWrapper {
	...
	public double handleRegression(int targetDatacenter, double[] values) {
		...
		try {
			if(targetDatacenter == DroneEdgeOrchestrator.EDGE_DATACENTER) {
			...
			else if(targetDatacenter == DroneEdgeOrchestrator.CLOUD_DATACENTER_VIA_RSU) {
			...
			else if(targetDatacenter == DroneEdgeOrchestrator.CLOUD_DATACENTER_VIA_GSM) {
