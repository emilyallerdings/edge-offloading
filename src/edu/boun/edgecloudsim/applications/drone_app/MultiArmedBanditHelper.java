...
public class MultiArmedBanditHelper {
    ...
    private int[] K_tn = {0, 0, 0, 0}; //number of task offloaded to EDGE_DATACENTER, CLOUD_DATACENTER_VIA_RSU, CLOUD_DATACENTER_VIA_GSM, Drone
    private double[] U_tn = {0, 0, 0, 0}; //empirical delay performance of the related datacenters
